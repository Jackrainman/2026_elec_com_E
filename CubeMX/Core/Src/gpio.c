...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, PE6_Pin|LED1_Pin|LED2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PE6_Pin LED1_Pin LED2_Pin */
  GPIO_InitStruct.Pin = PE6_Pin|LED1_Pin|LED2_Pin;
