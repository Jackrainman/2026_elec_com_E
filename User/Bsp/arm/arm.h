...
#define ARM_DEFAULT_ACC      0 /* 默认加速度 */
...
/* ========================== 相机坐标系偏移 ========================== */
#define CAM_X_CORRECT (-272.0f) /*!< X轴初始坐标系偏移 (mm) */ // 待测
#define CAM_Y_CORRECT (-36.0f) /*!< Y轴初始坐标系偏移 (mm) */ // 待测

// #define CAM_X_CORRECT (0.0f) /*!< X轴初始坐标系偏移 (mm) */ // 待测
// #define CAM_Y_CORRECT (0.0f) /*!< Y轴初始坐标系偏移 (mm) */ // 待测
